...
class IndexTTS2:
    def __init__(
        ...
        Args:
            ...
            on_progress (callable | None): optional ``(progress: int, stage: str)`` callback
                used by the API server to report load progress to the UI.
        """
        def report(progress, stage):
            if callable(on_progress):
                try:
                    on_progress(int(progress), stage)
                except Exception:
                    pass
        ...
        report(42, "Loading semantic encoder...")
        ...
        report(52, "Restoring semantic codec...")
        ...
        report(62, "Restoring acoustic model...")
        ...
        report(72, "Restoring speaker encoder...")
        # load campplus_model
        ...
        report(95, "Loading emotion matrices...")
